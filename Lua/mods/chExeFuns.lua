_exef = {
	...
	_RegisterHitHandler = ffi.cast("int (*__thiscall)(ObjectA*, const char*)", 0x004C7730),
	_RegisterAttackHandler = ffi.cast("int (*__thiscall)(ObjectA*, const char*)", 0x004C7810),
	_ChangeResolution = ffi.cast("int (*__thiscall)(int*,int, int)",0x429D80),
	_BlockClaw = ffi.cast("void (*)()", 0x421450),
	_TextOut = ffi.cast("int (*__thiscall)(int, const char *)", 0x0042C780),
	_KillClaw = ffi.cast("int (*)(ObjectA*, ObjectV*, void*, int)", 0x418BD0),
	_ClawGivePowerup = ffi.cast("int (*)(int, int)", 0x00420EE0),
	...
	_Physics = ffi.cast("int (*__thiscall)(int, ObjectA*, int, int, int)", 0x004CC7E0),
	_IsVisible = ffi.cast("int (*__thiscall)(int, int, int, int, int)", 0x004CE620),
	_AlignToGround = ffi.cast("int (*__thiscall)(int, ObjectA*, int)", 0x4CE420),
	_CreateObject = ffi.cast("ObjectA* (*__thiscall)(int, int, int, int, int, const char *, unsigned int)", 0x004C9480),
	_SetImage = ffi.cast("int (*__thiscall)(ObjectA*, const char*)", 0x004C6DD0),
	_SetAnimation = ffi.cast("int (*__thiscall)(ObjectA*, const char*, int)", 0x004C6E40),
	...
	_LoadAsset = ffi.cast("int (*__thiscall)(int this, const char*, void**)", 0x004FC6B4),
	...
	_PlaySound = ffi.cast("int (*__thiscall)(void*, int, int, int, int)", 0x00421BB0),
	_ClawSound = ffi.cast("ObjectA* (*)(const char*,int)", 0x48FB00),
	_AnimationStep = ffi.cast("int (*__thiscall)(void*, unsigned int)", 0x004C8550),
